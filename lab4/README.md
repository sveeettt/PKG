...
- **Дебаунсинг** событий мыши для производительности
...
### **Веб-интерфейс:**
- Откройте Developer Tools (F12) для отладки
- Проверяйте Console для ошибок JavaScript
- Мониторьте Performance для анализа скорости

### **Docker-мониторинг:**
```bash
# Просмотр логов
docker logs raster-app

# Мониторинг ресурсов
docker stats raster-app

# Проверка состояния
docker inspect raster-app
```
...
- Батчинг операций отрисовки
- Минимизация перерисовок

##  Вклад в развитие

### **Добавление нового алгоритма:**
1. Реализуйте функцию в `script.js`
2. Добавьте обработчик в `ui.js`
3. Обновите HTML-интерфейс
